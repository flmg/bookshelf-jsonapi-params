...
exports.default = function (Bookshelf) {
    ...
    var fetchJsonApi = function fetchJsonApi(opts) {
         ...
         * @return  {object}
         */
        internals.extractFunction = function (attribute) {
            var regex = new RegExp(/(.*)(count|sum|avg|max|min|lower|upper)\((.+)\)/g);
        ...
        internals.buildSort = function () {
            ...
            if ((0, _lodash.isArray)(sortValues) && !(0, _lodash.isEmpty)(sortValues)) {
                ...
                (0, _lodash.forEach)(sortValues, function (sortBy) {
                    ...
                    if (sortBy) {
                        internals.model.orderBy(internals.formatRelation(sortBy), sortDesc.indexOf(sortBy) === -1 ? 'asc' : 'desc');
                    }
                });
            }
        };
